...
from dbo.fn_Drew_Restore_Opportunities_RestoreTree_t(@SourceDBPath, @TargetDBPath)

--execute restore

exec sp_Drew_RestoreItem @SourDB = @SourceDBPath, @TarDB = @TargetDBPath, @RestoreTree = @RestoreTree, @MainRecordID = @OpportunitiesID, @NestLevel = 1
