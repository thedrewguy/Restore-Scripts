if object_id('fn_Drew_Restore_MedAddresses_DiffTable_t') is not null
	drop function fn_Drew_Restore_MedAddresses_DiffTable_t
go

create function fn_Drew_Restore_MedAddresses_DiffTable_t()
...
as begin
	...
	('LinkAddressToMCRContract', N'WHERE AddressesID = @MainRecordID'),
